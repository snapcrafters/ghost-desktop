...
Snapcrafters ([join us](https://forum.snapcraft.io/t/join-snapcrafters/1325)) are working to land snap install documentation and the [snapcraft.yaml](https://github.com/snapcrafters/ghost-desktop/blob/master/snap/snapcraft.yaml) upstream so Ghost Desktop can authoritatively publish future releases.
